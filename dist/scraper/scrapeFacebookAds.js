...
exports.scrapeFacebookAds = scrapeFacebookAds;
...
async function scrapeFacebookAds({ company }) {
    ...
    try {
        ...
        while (sameCountRounds < maxSameCountRounds) {
            ...
            console.log(`↻ Scroll ${sameCountRounds + 1}/${maxSameCountRounds} | ads on page: ${currentAdCount}`);
            if (currentAdCount >= MAX_ADS)
                break;
